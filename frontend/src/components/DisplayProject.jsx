...
// 展示一个项目的所有任务
const DisplayProject = ({ project, getAllProjects}) => {
        ...
        <>
            <nav className="navbar  bg-success navbar-dark rounded mb-2 ">
                <div className="container">
                    ...
                    <button className="navbar-toggler bg-primary text-dark" data-bs-toggle="modal" data-bs-target={"#updateProject-" + project.id}>
                        修改项目
                    </button>
                    ...
                    <div className="collapse navbar-collapse text-center" id={"navmenu-" + project.id}>
                        ...
                        <div className="text-center row">
                            <button className="btn btn-primary btn-sm mb-2" data-bs-toggle="modal" data-bs-target={"#createTask-" + project.id}>
                                创建一个任务
                            </button>
